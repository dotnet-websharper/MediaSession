...
function setupMediaSession(){
  ...
  const artWork1=(r={},r.src="https://via.placeholder.com/96",r.sizes="96x96",r.type="image/png",r);
  const artWork2=(r_1={},r_1.src="https://via.placeholder.com/128",r_1.sizes="128x128",r_1.type="image/png",r_1);
  if(!(navigator.mediaSession==null)){
    const metadata=new MediaMetadata((r_2={},r_2.title="SoundHelix Song",r_2.artist="Composer Name",r_2.album="Sample Album",r_2.artwork=[artWork1, artWork2],r_2));
...
let _c=Lazy((_i) => class $StartupCode_Client {
  ...
  static audio;
  static {
    this.audio=globalThis.document.getElementById("audio");
  }
});
